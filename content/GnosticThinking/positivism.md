...
У него же, по сути, появляются вот эти намеки на феминизм.
...
То есть неконтролируемый потенциал этой внутренней свободы человека, неконтролируемый потенциал внутреннего человека, это Конта пугает.
...
То есть у него скорее идет несовершенство человеческого общества в нынешнем состоянии, потому что оно не управляется вот этими правильными вещами.
...
А это как раз такая структура, которая является таким идеальным тоталитаризмом, направленным, как всегда, ко всем общему благу, потому что весь этот пролетариат будет осчастливен.
...
Повторюсь, это ключевой элемент, что просветленные, они свободны даже от собственных догм, потому что они, по сути, эти догмы в себе воплощают.
...
**Е.Голуб:**
Очень логично Это тоже позитивно, объективно существующее явление, поэтому может быть совершенно свободно основанием для любых выводов, действий и всего остального.
...
Как я это понял, повторюсь, у него, если ты хочешь, у него серьезные противоречия, полным-полно.
...
То есть там противоречий, если говорить серьезно, нереальное абсолютно количество, но кто же на них будет смотреть, когда оно обещает тебе, по сути, для элиты безграничную власть, а остальным красивую картинку.
