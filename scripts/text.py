...
COURSE_SHELEST = [
  ...
  ("2025_07_28", False, reversed(SHELEST)),
]
...
COURSE_BOBYLEV = [
  ...
  ('2025_08_12', False, reversed(BOBYLEV)),
  ('2025_08_14', False, reversed(BOBYLEV)),
]
...
COURSE_ASKERHANOV = [
  ...
  ('2025_07_23', False, reversed(ASKERHANOV)),
]
...
COURSE_URALOV = [
  ...
  ('2025_07_17', False, (
    Speak.Uralov, Speak.Shchelin, Speak.Chadaev, Speak.Kniazev,
    Speak.Kniazev, Speak.Chadaev, Speak.Shchelin, Speak.Uralov,
  )),
  ('2025_08_21', False, (
    Speak.Chadaev, Speak.Shchelin, Speak.Uralov,
    Speak.Chadaev, Speak.Shchelin, Speak.Uralov, Speak.Kniazev,
  )),
]

GOLUB_SEASON_01 = [
  ("Season01/pinker", True, GOLUB),
  ("Season01/apocalypse", True, reversed(GOLUB)),
  ("Season01/faust", True, reversed(GOLUB)),
  ("Season01/identity", True, reversed(GOLUB)),
  ("Season01/orange", True, GOLUB),
  ("Season01/snowflakes", True, GOLUB),
  ("Season01/limits", True, GOLUB),
  ("Season01/ai", True, reversed(GOLUB)),
  ("Season01/vr", True, reversed(GOLUB)),
  ("Season01/mt", True, reversed(GOLUB)),
  ("Season01/otvety", True, GOLUB),
  ("Season01/final", True, reversed(GOLUB)),
]
GOLUB_SEASON_02 = [
  ("Season02/your-flash-memory-card-with-identity", True, reversed(GOLUB)),
  ("Season02/placeandtime", True, reversed(GOLUB)),
  ("Season02/political-identity", True, GOLUB),
  ("Season02/asabiya", True, reversed(GOLUB)),
  ("Season02/the-crisis-of-identity", True, reversed(GOLUB)),
  ("Season02/mimetic", True, reversed(GOLUB)),
  ("Season02/technology-instead-of-faith", True, GOLUB),
  ("Season02/a-leap-of-faith", True, GOLUB),
  ("Season02/identity-conclusion", True, GOLUB),
  ("Season02/identity-qa", True, reversed(GOLUB)),
  ("Season02/monarchs-and-agenda", True, reversed(GOLUB)),
  ("Season02/the-joy-of-understanding", True, GOLUB),
]
GOLUB_SEASON_03 = [
  ("Season03/republic", True, reversed(GOLUB)),
  ("Season03/democracy", True, GOLUB),
  ("Season03/imperia", True, reversed(GOLUB)),
  ("Season03/people", True, reversed(GOLUB)),
  ("Season03/reforma", True, reversed(GOLUB)),
  ("Season03/renaissance", True, reversed(GOLUB)),
  ("Season03/varlaam", True, reversed(GOLUB)),
  ("Season03/bacon", True, reversed(GOLUB)),
  ("Season03/mendacium", True, GOLUB),
  ("Season03/enlightenment", True, reversed(GOLUB)),
  ("Season03/obscurantism", True, GOLUB),
  ("Season03/final3", True, reversed(GOLUB)),
]
GOLUB_SEASON_04 = [
  ("Season04/ontology_of_lies", True, reversed(GOLUB)),
  ("Season04/freedom-and-quadrobers", True, reversed(GOLUB)),
  ("Season04/battle_of_the_sexes", True, GOLUB),
  ("Season04/human_vs_humanity", True, GOLUB),
  ("Season04/confession", True, reversed(GOLUB)),
  ("Season04/muses_of_tradition", True, GOLUB),
  ("Season04/vinaiotvetsvennosti", True, GOLUB),
  ("Season04/the-courage-to-be", True, reversed(GOLUB)),
  ("Season04/dukhovny-fast-food", True, (Speak.Golub, Speak.Shevchenko, Speak.Shchelin)),
  ("Season04/lukewarm", True, reversed(GOLUB)),
  ("Season04/narrative-wars", True, GOLUB),
  ("Season04/eschatological-optimism", True, GOLUB),
]
GOLUB_SEASON_05 = [
  ("Season05/veritnelzyaproverit", True, reversed(GOLUB)),
  ("Season05/osedlat-cherta", True, reversed(GOLUB)),
  ("Season05/silicon-overlords", True, reversed(GOLUB)),
  ("Season05/the-existential-pub", True, reversed(GOLUB)),
...
GOLUB_OTHER = [
  ...
  ("Singles/year2024", True, reversed(GOLUB)),
  ("Singles/2025_10_04", True, GOLUB),
  ("Singles/2026_01_03", True, GOLUB),
