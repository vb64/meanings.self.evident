...
MDATA = {
  Course.InSearchOfMeaning: [
      ...
      ("Season06/uprazdenenie-blagovremenie", (Speak.Golub, Speak.Shchelin)),
      ("Season06/credit-or-gift", (Speak.Shchelin, Speak.Golub)),
      ("Season06/eros", (Speak.Golub, Speak.Shchelin)),
      ("Season06/family", (Speak.Golub, Speak.Shchelin)),
      ("Season06/vybor-benedikta", (Speak.Shchelin, Speak.Golub)),
      ("Season06/yazyk-vechnosti", (Speak.Shchelin, Speak.Golub)),
  ],
  Course.NamingTheSelfEvident: [
      ...
      ("2026_04_30", (Speak.ShchelinEn, Speak.Heers_J)),
      ("2026_05_08", (Speak.Heers_J, Speak.ShchelinEn)),
      ("2026_05_15", (Speak.Heers_J, Speak.ShchelinEn)),
  ],
  Course.Shelest: [
      ...
      ("2026_03_19", (Speak.Shchelin, Speak.Shelest)),
      ("2026_04_14", (Speak.Shchelin, Speak.Shelest)),
      ...
      ("2026_09_07", (Speak.Shchelin, Speak.Shelest)),
  ],
  Course.Dudnik: [
      ...
      ("2026_04_24", (Speak.Shchelin, Speak.Dudnik)),
      ("2026_05_29", (Speak.Shchelin, Speak.Dudnik)),
      ("2026_07_08", (Speak.Shchelin, Speak.Dudnik)),
      ("2026_08_15", (Speak.Shchelin, Speak.Dudnik)),
  ],
  Course.Panchenko: [
  ...
  Course.Singles: [
      ...
      ("2026_07_10", (Speak.Shchelin, Speak.ABabaev)),
      ("2026_09_03", (Speak.Bondarenko, Speak.Shchelin, Speak.Golub)),
      ("2026_09_08", (Speak.Shchelin, Speak.VKuchushev)),
      ("2026_09_19", (Speak.Shchelin, Speak.AFedorov, Speak.AMorozov)),
  ],
  Course.Safarov: [
      ...
      ("2026_03_31", (Speak.RSafarov, Speak.Shchelin)),
      ("2026_04_26", (Speak.Shchelin, Speak.RSafarov)),
      ("2026_05_26", (Speak.Shchelin, Speak.RSafarov)),
      ("2026_07_01", (Speak.Shchelin, Speak.RSafarov)),
      ("2026_07_29", (Speak.Shchelin, Speak.RSafarov)),
      ("2026_08_25", (Speak.Shchelin, Speak.RSafarov)),
  ],
  Course.Uralov: [
      ...
      ("2026_03_19", (Speak.Shchelin, Speak.Kniazev, Speak.Uralov, Speak.Kniazev, Speak.Chadaev, Speak.Shchelin, Speak.Uralov)),
      ("2026_04_16", (Speak.Shchelin, Speak.Kniazev, Speak.Uralov, Speak.Shchelin, Speak.Chadaev, Speak.Uralov, Speak.Kniazev)),
  ...
  Course.Tkachev: [
      ...
      ("2026_03_27", (Speak.Shchelin, Speak.ATkachev)),
      ...
      ("2026_08_13", (Speak.Shchelin, Speak.ATkachev)),
      ("2026_08_14", (Speak.Shchelin, Speak.ATkachev)),
      ("2026_08_21", (Speak.ATkachev, Speak.Shchelin)),
      ("2026_08_29", (Speak.ATkachev, Speak.Shchelin)),
  ],
  Course.Sputnik: [
      ...
      ("2026_04_20", (Speak.POstrovsky, Speak.Shchelin, Speak.PUvarova)),
  ],
  Course.Chernov: [
  ...
  Course.Mash: [
      ...
      ("2026_09_03", (Speak.Shchelin, Speak.Izotov, Speak.OrlovSm)),
  ],
  Course.Sobolev: [
